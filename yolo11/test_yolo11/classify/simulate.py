...
def main():
    ...
    parser.add_argument("--model", type=str,default="best_224_s_cls.onnx", help='original model file')
    parser.add_argument("--model_input", type=str,default="onnx_input_float32.bin", help='input bin file for original model')
    parser.add_argument("--kmodel", type=str,default="best_224_s_cls.kmodel", help='kmodel file')
